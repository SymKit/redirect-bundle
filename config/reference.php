 ...
 *     },
 * }
 * @psalm-type SymkitRedirectConfig = array{
 *     enabled?: bool|Param, // Master switch to enable or disable the bundle features. // Default: true
 *     doctrine?: array{
 *         entity_class?: scalar|Param|null, // FQCN of the redirect entity. // Default: "Symkit\\RedirectBundle\\Entity\\Redirect"
 *     },
 *     admin?: array{
 *         enabled?: bool|Param, // Enable the admin CRUD controller for redirects. // Default: true
 *         route_prefix?: scalar|Param|null, // Prefix for admin route names (e.g. admin_redirect_list). // Default: "admin_redirect"
 *         path_prefix?: scalar|Param|null, // URL path prefix for admin routes. // Default: "/admin/redirects"
 *     },
 *     listener?: array{
 *         enabled?: bool|Param, // Enable the request listener that performs redirects. // Default: true
 *     },
 *     search?: array{
 *         enabled?: bool|Param, // Register the redirect search provider for global search. // Default: true
 *     },
 * }
 ...
 *     },
 * }
 * @psalm-type SymkitRoutingConfig = array{
 *     enabled?: bool|Param, // Master switch to enable or disable the bundle features. // Default: true
 *     entity_class?: scalar|Param|null, // FQCN of the route entity (must implement RouteEntityInterface). // Default: "Symkit\\RoutingBundle\\Entity\\Route"
 *     admin?: array{
 *         enabled?: bool|Param, // Enable the admin CRUD controller for routes. // Default: true
 *         path_prefix?: scalar|Param|null, // URL prefix for admin routes (list and edit). // Default: "/admin/routes"
 *     },
 *     sitemap?: array{
 *         enabled?: bool|Param, // Register the database sitemap loader. // Default: true
 *     },
 *     search?: array{
 *         enabled?: bool|Param, // Register the route search provider for global search. // Default: true
 *     },
 *     listener?: array{
 *         invalidate_sitemap_on_change?: bool|Param, // Dispatch sitemap invalidate event when a route is persisted/updated/removed. // Default: true
 *     },
 * }
 ...
 *     symkit_redirect?: SymkitRedirectConfig,
 *     doctrine?: DoctrineConfig,
 *     symkit_routing?: SymkitRoutingConfig,
 *     "when@test"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
